...
var $author$project$Main$init = {v: false, A: $elm$core$Maybe$Nothing};
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_update(
					...
					{
						v: false,
						A: $elm$core$Maybe$Just(str)
					});
			case 2:
				return _Utils_update(
					model,
					{v: false, A: $elm$core$Maybe$Nothing});
			default:
				return _Utils_update(
					model,
					{v: true});
...
var $author$project$Main$LeaveElement = {$: 2};
var $author$project$Main$CopyColor = {$: 1};
var $author$project$Main$HoverColor = function (a) {
	return {$: 0, a: a};
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$class('icon_' + name),
...
var $author$project$Main$isColor = F2(
	function (model, color) {
		var _v0 = model.A;
		if (!_v0.$) {
			var it = _v0.a;
			return _Utils_eq(it, color);
		} else {
			return false;
		}
	});
...
var $author$project$Main$colorBlock = F2(
	function (model, color) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$attribute, 'data-copy', color),
					$elm$html$Html$Events$onMouseEnter(
					$author$project$Main$HoverColor(color)),
					$elm$html$Html$Events$onClick($author$project$Main$CopyColor)
				]),
			A2($author$project$Main$isColor, model, color) ? _List_fromArray(
				[
					A2(
					$elm$html$Html$div,
					_List_fromArray(
					...
					model.v ? 'dialog-ok-apply' : 'edit-copy',
					'16px')
				]) : _List_Nil);
	});
var $author$project$Main$colorRow = F2(
	function (model, colors) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				function (it) {
					return A2($author$project$Main$colorBlock, model, it);
				},
				colors));
	});
var $author$project$Main$farben = _List_fromArray(
	[
		_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$onMouseLeave($author$project$Main$LeaveElement)
			]),
		A2(
			$elm$core$List$cons,
			$author$project$Main$stylesheet('https://cdn.kde.org/breeze-icons/icons.css'),
			A2(
				$elm$core$List$map,
				function (it) {
					return A2($author$project$Main$colorRow, model, it);
				},
				$author$project$Main$farben)));
};
