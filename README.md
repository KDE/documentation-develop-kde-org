...
Download a Hugo release (extended version, latest supported release: v0.150.0) from [here](https://github.com/gohugoio/hugo/releases/tag/v0.150.0) and clone this repo. Once you've cloned the site repo, enter the repo root folder.
