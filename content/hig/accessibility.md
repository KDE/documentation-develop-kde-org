...
Icons rely on the user's cultural context to be understood. Ensure that icons are changed as necessary for different locales. Guidance can be found in the [Icon Localization guidelines]({{< ref "icons/localization" >}}).
