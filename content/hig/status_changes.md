...
OSDs are useful when knowledge of the new state is important for the user, or when an action that is quick but not instant has completed. Examples of where this is appropriate include:
