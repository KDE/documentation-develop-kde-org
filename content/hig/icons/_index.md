...
- Group buttons by function in the tabs of a [Kirigami.NavigationTabBar](docs:kirigami;org.kde.kirigami.NavigationTabBar).
...
- For standard actions, use [KStandardActions](docs:kconfigwidgets;KStandardAction) so that it gets a standard icon, too.
