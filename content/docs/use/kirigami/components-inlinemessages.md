...
![A window showing a button which when clicked makes an inline message with light blue background pop up with text above it, near the top of the application](/docs/use/kirigami/components-inlinemessages/inlinemessages-simple.png)
...
![A window showcasing all four inline message types in blue, green, orange and red](/docs/use/kirigami/components-inlinemessages/inlinemessages-types.png)
...
![An inline message with rich text and a hyperlink](/docs/use/kirigami/components-inlinemessages/inlinemessages-richtext.png)
...
![An inline message with a custom icon](/docs/use/kirigami/components-inlinemessages/inlinemessages-icon.png)
...
![An inline message with close button to its right side](/docs/use/kirigami/components-inlinemessages/inlinemessages-closebutton.png)
