...
| [Figuring out main.cpp](/docs/kirigami/advanced-maincpp)  | Getting to grips with the central C++ file that handles your application's initialisation. |
...
| [About Page](/docs/kirigami/advanced-add_about_page) | Add an "About Page" to your UI.  |
...
QtWidgets are somewhat more daunting to work with than QML (and *much* more C++ intensive!). Luckily, we have [a set of tutorials](/docs/use/kxmlgui) in the KDE Docs that will help you become more familiar with them.
...
We recommend you also take a look at [Kirigami Gallery](https://apps.kde.org/kirigami2.gallery/), an application designed by KDE developers to demonstrate Kirigami's tools and capabilities. It provides both interactive examples of Kirigami components as well as links to the source code of these examples so you can see how they were built. You can read more about Kirigami Gallery in our [specific Kirigami Gallery tutorial](/docs/kirigami/introduction-kirigami-gallery).
