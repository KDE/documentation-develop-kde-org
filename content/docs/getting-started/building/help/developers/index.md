...
If your Matrix client supports browsing spaces (like Element) then you can join the [KDE Community Matrix Space](https://go.kde.org/matrix/#/#kde-community:kde.org). It will display the same list of rooms as you see below, but easily accessible inside of your client.
