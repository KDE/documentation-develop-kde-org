...
This project will use CMake to call Cargo, which in turn will build the project. CMake is needed because Cargo lacks the necessary features to install GUI desktop applications.
