...
We then import and use [corrosion-rs](https://corrosion-rs.github.io/corrosion/), which reads the existing Cargo.toml file and generates an executable for us.
...
{{< readfile file="/content/docs/getting-started/rust/rust-app/simplemdviewer/CMakeLists.txt" highlight="cmake" start=15 lines=3 >}}

If the user specifies an out-of-tree build directory in their CMake build command, Cargo will use the directory specified by the user instead of the `target/` directory:
...
{{< readfile file="/content/docs/getting-started/rust/rust-app/simplemdviewer_final/CMakeLists.txt" highlight="cmake" emphasize="18-20" >}}
