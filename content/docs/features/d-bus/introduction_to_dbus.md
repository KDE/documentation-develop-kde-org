...
On modern distributions using Qt 6, this command is often named `qdbus6` to distinguish it from the Qt 5 version.
...
Similarly to the command line tool, on Qt 6 systems this application may be named `qdbusviewer6`.