...
in [KConfig XT syntax]({{< ref "docs/use/configuration/kconfig_xt" >}}). The
...
`Int, StringList, Double, Color,...`. [The KConfigXT tutorial]({{< ref "docs/use/configuration/kconfig_xt" >}})
