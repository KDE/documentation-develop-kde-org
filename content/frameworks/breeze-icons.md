...
## Design Guidelines
The Breeze icons guidelines are described in the [KDE Human Interface Guidelines (HIG)](https://develop.kde.org/hig/icons/). To help contribute to KDE design, please join [the KDE Visual Design Group](https://community.kde.org/Get_Involved/design).
