...
content or controls. The panel shows information on four levels indicated by 
different colors and icons, and provides standard action that users might want 
to initiate.
